...
public class SelectionScreen2 extends JFrame {
    ...
    public SelectionScreen2() {
        ...
        // Buttons
        String[] buttonLabels = {"Tính nồng độ phần trăm", "Tính nồng độ mol", "Tính nồng độ đương lượng", "Tính nồng độ molan"};
        ...
        backButton.setFont(new Font("Arial", Font.BOLD, 34));
